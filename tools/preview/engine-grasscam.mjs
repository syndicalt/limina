...
const out = process.argv[2] || resolve(ROOT, "tools/preview/out/grass-v2-eye.png");
const query = process.argv[3] || ""; // e.g. "scene=/tools/preview/authored-village.json&cx=-15&cz=14&yaw=0.6"
...
await page.goto(`http://localhost:${port}/tools/preview/engine-grasscam.html`+(query?("?"+query):""), { waitUntil:"load", timeout:40000 });
...
for (const s of await page.evaluate("window.__status||[]")) console.error("STATUS: "+s.slice(0,60));

...
const ok = buildSliceViaLlmff({ sliceId: "slice-0", dodIds: ["collect-wins"] });
...
const bad = buildSliceViaLlmff({ sliceId: "slice-0", dodIds: ["collect-wins"] }, { broken: true });
...
const plan = { slices: [
  { id: "slice-0", name: "Playable loop", dodIds: ["collect-wins"] },

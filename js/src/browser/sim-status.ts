/** Version 1 of the fixed 16-byte sim-worker status bridge. Slot 0 remains the
 * legacy completed-tick counter so older readers can keep loading it directly. */
export const SIM_STATUS_LAYOUT_VERSION = 1;
export const SIM_STATUS_INTS = 4;

// hedgehog_dance — a procedural hedgehog dances + SINGS to a procedural dance
...
//   ./target/release/limina --window js/src/demos/hedgehog_dance.ts
...
ops.op_log(`hedgehog_dance ready: a hedgehog dancing + singing to a ${BPM} BPM procedural track (music bed + pitched TTS, both through limina-audio)`);

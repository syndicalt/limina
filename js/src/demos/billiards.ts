// limina billiards demo (windowed): a bordered table of static-box rails, a
...
//
// Run: limina --window js/src/demos/billiards.ts
//
...
ops.op_log("billiards demo ready: cue break -> Rapier -> ECS -> three (balls roll on the cloth)");
